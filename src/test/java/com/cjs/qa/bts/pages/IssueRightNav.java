...
public class IssueRightNav extends Page {
  ...
  //   private static final String nodePolicyIssuance =
  // "form1:adminFunctions:policyIssuanceFunctions:";
  ...
  public boolean isSidebarOpen() {
    return getWebElement(sidebarRightClose) != null;
  }

  public void toggleSidebarRight() {
    boolean sidebarIsOpen = isSidebarOpen();
    if (sidebarIsOpen) {

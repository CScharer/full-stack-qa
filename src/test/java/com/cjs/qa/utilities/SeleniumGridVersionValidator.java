...
public final class SeleniumGridVersionValidator {
  ...
  public enum VersionTolerance {
    /** Must match exactly (e.g., 4.41.0 == 4.41.0) */
    EXACT,
    /** Allow minor version differences (e.g., 4.41.0 == 4.42.0) */
    MINOR,
    /** Allow patch version differences (e.g., 4.41.0 == 4.41.1) */
    PATCH,
   ...
   * @return The server version string (e.g., "4.41.0")
   ...
   *
   * @return The client version string (e.g., "4.41.0")
   */

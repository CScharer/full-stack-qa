...
public class LoginPage extends Page {
  ...
  public void load() throws QAException {
    maximizeWindow();
    LOG.debug("Loading: [{}]", LinkedInEnvironment.URL_LOGIN);
  ...
  public void validatePage(DataTable dataTable) {
    ...
    Assertions.assertSame(
        expected.toString(), actual.toString(), this.getClass().getName() + "validatePage");
  }

  public void login(
      LoginAlternatePage loginAlternatePage, String emailAddressUserName, String password)
      throws Throwable {
    load();
    ...
    if (objectExists(getByEditEmail(), 3)) {
      ...
      loadAlternate();
      LOG.info("Login Alternate Page Determined");

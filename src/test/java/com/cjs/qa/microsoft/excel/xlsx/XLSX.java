...
public class XLSX implements IExcel {

  private static final GuardedLogger LOG = new GuardedLogger(LogManager.getLogger(XLSX.class));
  ...
  private XSSFRow workRow = null;
  private XSSFCellStyle workCellStyle = null;
  ...
  public XLSX(String fileName, String sheetName) throws QAException, IOException {
    ...
    LOG.debug("fileName:[{}], sheet:[{}]", getFileName(), sheetName);
    if (!JavaHelpers.hasValue(sheetName)) {
      sheetName = SHEET_DEFAULT;
    }
    LOG.debug(
        "fileType Expected: [{}], fileName:[{}], sheet:[{}]",
  ...
  public boolean addComment(int sheet, int column, int row, String sComment, boolean visible)
    ...
    setWorkCell(getWorkRow().getCell(column));
    setWorkCellStyle((XSSFCellStyle) getWorkCell().getCellStyle());
  ...
  public boolean addLink(
    ...
    getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), FORMAT_NAME_HYPERLINK));
    //
    // final CellStyle cellStyleNew = getWorkbook().createCellStyle();
    // cellStyleNew.cloneStyleFrom(XLSXCellStyles.getCellStyle(getWorkbook(),
  ...
  public XSSFSheet createSheet(String sheet) throws QAException {
    if (!sheetExists(sheet)) {
      setWorkSheet(getWorkbook().createSheet(sheet));
    }
    // setWorkSheet(getWorkbook().createSheet(sheet));
  ...
  public void createSheet(String sheet, String contents) throws QAException {
    try {
      setWorkbook(new XSSFWorkbook(new FileInputStream(getFileName())));
      setWorkSheet(createWorkSheet(sheet, contents));
      LOG.debug("{}", getWorkSheet().toString());
  ...
  private XSSFSheet createWorkSheet(String sheetName, String contents) throws QAException {
    final XSSFSheet sheet = getWorkbook().getSheet(sheetName);
  ...
  private void fileWrite() throws QAException {
    try {
      ...
      //
      // setWorkbook(new XSSFWorkbook(new
  ...
  private String getCellValue(Cell xCell) throws QAException {
    ...
    return DATA_FORMATTER.formatCellValue(xCell, formulaEvaluator).trim();
  }
  ...
  private XSSFCellStyle getWorkCellStyle() {
    return workCellStyle;
  }

  private XSSFRow getWorkRow() {
    return workRow;
  }
  ...
  private void setCellStyles() throws QAException {
    XLSXCellStyles.setCellStyles(getWorkbook());
  }
  ...
  private void setCellValue(Object value) throws QAException {
    ...
    if (value instanceof Double doubleValue) {
      ...
      getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), FORMAT_NAME_NUMBER));
    }
      ...
      try {
        if (containsPercentSign || isNumeric) {
          ...
          if (containsPercentSign) {
            ...
            getWorkCell()
                .setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), FORMAT_NAME_PERCENT));
          } else if (isNumeric) {
            valueFloat = Float.valueOf(stringValue.trim()).floatValue();
            setCellValue(valueFloat);
            getWorkCell()
                .setCellStyle(
                    XLSXCellStyles.getCellStyle(getWorkbook(), FORMAT_NAME_NUMBERPERCENT));
          }
        } else {
          getWorkCell().setCellValue(Integer.valueOf(stringValue));
          getWorkCell()
              .setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), FORMAT_NAME_NUMBER));
        }
  ...
  public void setFormatBold(int sheet, int column, int row) throws QAException {
    ...
    setWorkCell(getWorkRow().getCell(column));
    getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), FORMAT_NAME_BOLD));
  }
  ...
  public void setFormatFail(int sheet, int column, int row) throws QAException {
    ...
    setWorkCell(getWorkRow().getCell(column));
    getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), FORMAT_NAME_FAIL));
  }
  ...
  public boolean setFormatFontBackgroundColor(int sheet, int column, int row, String color)
    ...
    if (!COLORS_ALLOWED.contains(color.toLowerCase(Locale.ENGLISH))) {
      return false;
    }
    setWorkCell(getWorkRow().getCell(column));
    getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), FORMAT_NAME_HEADING));
    return true;
  }
  ...
  public boolean setFormatFontColor(int sheet, int column, int row, String color)
    ...
    setWorkCell(getWorkRow().getCell(column));
    setWorkCellStyle(
        (XSSFCellStyle) XLSXCellStyles.getCellStyle(getWorkbook(), FORMAT_NAME_HYPERLINK));
    final XSSFFont hssfFont = getWorkbook().createFont();
  ...
  public void setFormatNormal(int sheet, int column, int row) throws QAException {
    ...
    setWorkCell(getWorkRow().getCell(column));
    getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), FORMAT_NAME_NORMAL));
  }
  ...
  public void setFormatPass(int sheet, int column, int row) throws QAException {
    ...
    setWorkCell(getWorkRow().getCell(column));
    getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), FORMAT_NAME_PASS));
  }
  ...
  public void setFormatSection(int sheet, int column, int row) throws QAException {
    ...
    setWorkCell(getWorkRow().getCell(column));
    getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), FORMAT_NAME_SECTION));
  }
  ...
  public void setFormatStatus(int sheet, int column, int row) throws QAException {
    ...
    setWorkCell(getWorkRow().getCell(column));
    getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), FORMAT_NAME_STATUS));
  }
  ...
  private void setWorkCellStyle(XSSFCellStyle workCellStyle) {
    this.workCellStyle = workCellStyle;
  }

  private void setWorkRow(XSSFRow workRow) {

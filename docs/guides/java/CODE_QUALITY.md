...
**See Also**:
- [Git Hooks Installation](../README.md#5--automatic-git-hooks-installation) - Automatic code formatting
- [GitHub Actions CI/CD](../infrastructure/GITHUB_ACTIONS.md) - Code quality in CI pipeline
- [@SuppressWarnings Inventory](../../work/20251225_SUPPRESS_WARNINGS_INVENTORY.md) - Complete inventory of suppressions

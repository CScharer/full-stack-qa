...
- `[ ]` **Verify Selenium Client/Server Version Match** (if Selenium changes)
  ...
  - **Required**: Versions must match (e.g., client 4.41.0 = server 4.41.0)
  - **Note**: Server version is now centralized in workflow input variable `selenium_version` (default: 4.41.0)

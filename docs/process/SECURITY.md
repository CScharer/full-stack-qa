...
- **Version inventory** - [VERSION_TRACKING.md](./VERSION_TRACKING.md) records current pins and update history (including Jackson **3.2.1** / 2.x **2.22.1**, Vite **8.1.5**, TypeScript **6.0.3**, Hibernate **6.6.54.Final**, Selenium **4.46.0**, Next **16.2.11**, JSoup **1.23.1**, Allure2 Java **2.35.3**, HttpClient 5 **5.6.3** / HttpCore 5 **5.4.3**, npm overrides for brace-expansion / postcss / js-yaml / sharp / nanoid / @babel/core; Dockerfile **npm@11**)
